import{u as m,v as r,b as p,F as s,X as c,N as t,x as u,y as D,d as A,r as C,q as I,E as F,O as h,R as B,M as v,L as l}from"./chunks/framework.15266db3.js";const g=s("h3",null,"基本信息",-1),L=s("h3",null,"学校列表",-1),b=n=>new Promise(o=>setTimeout(o,n)),U=n=>new Promise(o=>setTimeout(o,n));function _(){const n=A(),o=()=>{n.value=null,b(1e3).then(a=>{n.value={id:1,name:"张三",age:Math.floor(Math.random()*99)+1}})};return o(),[n,o]}function k(n){return C(()=>{var o;return(((o=n.value)==null?void 0:o.age)||0)*2})}function S(n){const o=A(),a=()=>{U(1e3).then(e=>{o.value=[{id:1,date:"2023-01-12",school:"清华大学"},{id:2,date:"2000-10-12",school:"中国人民大学"}]})};return I(()=>{var e;return(e=n.value)==null?void 0:e.id},e=>{if(!e){o.value=[];return}a()}),o}const x=m({__name:"index.md.demo.3c00d722",setup(n){const[o,a]=_(),e=k(o),f=S(o),d=()=>{a()};return(M,R)=>{var y,i;return r(),p(u,null,[s("a",{href:"javascript:void(0)",onClick:d},"再次请求"),g,s("ul",null,[s("li",null,"用户名称："+c((y=t(o))==null?void 0:y.name),1),s("li",null,"用户年龄："+c((i=t(o))==null?void 0:i.age),1),s("li",null,"双倍年龄："+c(t(e)),1)]),L,s("ul",null,[(r(!0),p(u,null,D(t(f),E=>(r(),p("li",{key:E.id},c(E.date)+" - "+c(E.school),1))),128))])],64)}}}),P=B('<h1 id="hooks-组合api" tabindex="-1">Hooks 组合API <a class="header-anchor" href="#hooks-组合api" aria-label="Permalink to &quot;Hooks 组合API&quot;">​</a></h1><h2 id="优雅写hooks" tabindex="-1">优雅写hooks <a class="header-anchor" href="#优雅写hooks" aria-label="Permalink to &quot;优雅写hooks&quot;">​</a></h2><h3 id="script标签" tabindex="-1">script标签 <a class="header-anchor" href="#script标签" aria-label="Permalink to &quot;script标签&quot;">​</a></h3><ul><li>导入放最前面</li><li>页面定义，都是一行代码</li></ul><h2 id="script下的setup标签-init" tabindex="-1">script下的setup标签（init） <a class="header-anchor" href="#script下的setup标签-init" aria-label="Permalink to &quot;script下的setup标签（init）&quot;">​</a></h2><ul><li>页面公用方法，事件都定义到setup中</li></ul>',6),w=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"script"),s("span",{style:{color:"#E1E4E8"}}," "),s("span",{style:{color:"#B392F0"}},"lang"),s("span",{style:{color:"#E1E4E8"}},"="),s("span",{style:{color:"#9ECBFF"}},'"ts"'),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"  </"),s("span",{style:{color:"#22863A"}},"ul"),s("span",{style:{color:"#24292E"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"template"),s("span",{style:{color:"#24292E"}},">")])])])],-1),j=JSON.parse('{"title":"Hooks 组合API","description":"","frontmatter":{},"headers":[],"relativePath":"hooks/index.md","filePath":"hooks/index.md","lastUpdated":1695113414000}'),q={name:"hooks/index.md"},H=Object.assign(q,{setup(n){return(o,a)=>{const e=v("demo");return r(),p("div",null,[P,F(e,{customClass:"demoblock-custom",sourceCode:`<script lang="ts">
// 1. 导入放最前面
...
`},{highlight:h(()=>[w]),default:h(()=>[F(x)]),_:1})])}}});export{j as __pageData,H as default};
